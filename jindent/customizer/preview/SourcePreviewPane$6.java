...
class SourcePreviewPane$6 implements ActionListener {
   private final SourcePreviewPane a;

   SourcePreviewPane$6(SourcePreviewPane var1) {
      this.a = var1;
   }

   public void actionPerformed(ActionEvent var1) {
      float var2 = (float)SourcePreviewPane.access$400(this.a).getValue();
